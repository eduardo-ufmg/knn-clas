...
const int K_ARG = 4;
const char * USAGE = "Arguments: <test_samples_path INPUT> <support_samples_path INPUT> <predicted_samples_path OUTPUT> [k FLOAT]";
...
int main(int argc, char **argv)
{
  ...
  const PredictedSamples predictedSamples = kNSSpred(testSample, supportSamples, k);
